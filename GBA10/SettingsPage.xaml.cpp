...
void SettingsPage::watchVideobtn_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	MyVideoAd->ErrorOccurred += ref new Windows::Foundation::EventHandler<Microsoft::Advertising::WinRT::UI::AdErrorEventArgs ^>(this, &GBA10::SettingsPage::OnErrorOccurred);
	MyVideoAd->Cancelled += ref new Windows::Foundation::EventHandler<Platform::Object ^>(this, &GBA10::SettingsPage::OnCancelled);
	MyVideoAd->Completed += ref new Windows::Foundation::EventHandler<Platform::Object ^>(this, &GBA10::SettingsPage::OnCompleted);

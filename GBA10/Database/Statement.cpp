...
using namespace GBA10::SQLiteWinRT;
...
std::unique_ptr<char []> GBA10::SQLiteWinRT::PlatformStringToCharArray(Platform::String^ string)
{
...
void GBA10::SQLiteWinRT::WasteTimeToSimulateSlowOperation()
{
	auto handle = GetCurrentThread();
	WaitForSingleObjectEx(handle, WASTE_TIME_MS, FALSE);
}

Streams::IBuffer ^GBA10::SQLiteWinRT::CreateNativeBuffer(LPVOID lpBuffer, DWORD nNumberOfBytes)
{
